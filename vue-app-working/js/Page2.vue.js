const Page2 = {
  template: `
    <div>
      ...
      <div class="bg-white shadow-md rounded-lg p-4" v-for="compare in comparative" :key="comparative.id">
        <img class="w-full h-48 object-cover rounded-t-lg" src="https://t3.ftcdn.net/jpg/00/77/45/10/360_F_77451022_GxBDKhRdlYTJ9cZsKFEKlrvZEp8RPAkW.jpg" alt="Card Image">
          <div class="px-6 py-4">
           <h2 class="text-lg font-bold text-gray-800 mb-2">{{compare.category}}</h2>
